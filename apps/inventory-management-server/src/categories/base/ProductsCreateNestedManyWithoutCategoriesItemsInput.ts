...
@InputType()
class ProductsCreateNestedManyWithoutCategoriesItemsInput {
...
export { ProductsCreateNestedManyWithoutCategoriesItemsInput as ProductsCreateNestedManyWithoutCategoriesItemsInput };
