...
@InputType()
class ProductsUpdateManyWithoutCategoriesItemsInput {
...
export { ProductsUpdateManyWithoutCategoriesItemsInput as ProductsUpdateManyWithoutCategoriesItemsInput };
