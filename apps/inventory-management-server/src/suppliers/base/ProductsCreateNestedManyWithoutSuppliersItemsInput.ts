...
@InputType()
class ProductsCreateNestedManyWithoutSuppliersItemsInput {
...
export { ProductsCreateNestedManyWithoutSuppliersItemsInput as ProductsCreateNestedManyWithoutSuppliersItemsInput };
